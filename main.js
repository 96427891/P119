...
function update_canvas() {
    background("white");
    random_number = Math.floor((Math.random() * array.length) + 1);
    console.log(array);
    document.getElementById("hhh").innerHTML = "Canvas reset!";
}
function preload(){
...
if(error){
    ...
    console.log(results);
    drawn_sketch = Math.round(results[0].label * 100);
    document.getElementById("Confidence").innerHTML = "Your Sketch"+drawn_sketch+'%';
}
}